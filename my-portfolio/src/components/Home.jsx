    ...
    <section id="portfolio" className="section home-section">
      ...
      <div className="home-content">
        ...
        <div className="home-text">
          <p>
            Hi, I am Tisha <strong className="highlight">Software Developer</strong> Building meaningful web and mobile experiences through thoughtful design and clean code.{" "}
            Enjoys solving complex problems and turning ideas into efficient solutions.{" "}
