  ...
  return (
    <section id="portfolio" className="section home-section">
      ...
      <div className="home-content">
        <div className="home-profile-indicator">
        ...
        <div className="home-text">
          ...
          <h1 className="hero-title">Web & Mobile App Developer</h1>
          <p className="hero-description">
            I build modern, responsive web and mobile applications using HTML, CSS, JavaScript, React, and Expo (React Native).
            I enjoy creating smooth user experiences and turning ideas into real, usable products.
          </p>
        ...
        <div className="social-icons">
          <a href="mailto:tisha@example.com" className="social-icon" aria-label="Email">
